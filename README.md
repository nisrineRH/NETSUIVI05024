...
To build the final jar and optimize the NETSUIVI05024 application for production, run:
...
Then navigate to [http://localhost:8200](http://localhost:8200) in your browser.
